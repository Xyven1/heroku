  ...
  <v-container class="fill-height">
    <v-row class="fill-height"> 
      <v-col class="fill-height d-flex flex-column">
        <v-row class="shrink"> 
          <v-col>
            <v-text-field label="Search for user" autocomplete="off" @click:clear="search = ''; searchUsers()" v-model="search" prepend-inner-icon="mdi-magnify" v-debounce="searchUsers" clearable hide-details/>
          </v-col>
        </v-row>
        <v-row>
          <v-col>
